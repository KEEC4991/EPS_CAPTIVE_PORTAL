        ...
        <div class="container panel_general">
            <div class="row">
                <div class="col" align="center">
                    <div class="panel_reporte" style="margin-left: 0%;  width: 100%; height: 100%;">
                        <div align="left">
                            <h5 style="font-weight: bold;">CONSUMO DE SERVICIO DE INTERNET</h5>
                        </div>
                        <hr>
                        <div align="center">
            ...
            <div class="row">
                <div class="col" align="center">
                    <div class="panel_reporte" style="margin-left: 0%;  width: 100%; height: 100%; ">
                        ...
                        <div align="left">
                            <h5 style="font-weight: bold;">REPORTE DE POBLACIÓN REGISTRADA</h5>
                        </div>
                        <hr>

                        <canvas id="myChart" style="max-width: 33%; display: inline-block; "></canvas>
                        <script>
            ...
            <div class="row">
                <div class="col" align="center">
                    <div class="panel_reporte">
                        <div align="left">
                            <h5 style="font-weight: bold;">REPORTE DE DISPOSITIVOS CONECTADOS</h5>
                        </div>
                        ...
                        <hr style="margin-top: -2px;">
                        <div>
                            <canvas id="dispositivos_conectados" style="max-width: 80%; display: inline-block; "></canvas>
                            <script>
                        ...
                        <hr>
                        <p style="width: 45%; display: inline-block;">Fecha Tendencia Consumo: <input type="text" style="text-align: center; border-radius: 1px;" id="datepicker5"></p>
                        <hr>
            ...
            <div class="row">
                <div class="col" align="center">
                    <div class="panel_reporte">
                        <div align="left">
                            <h5 style="font-weight: bold;">REPORTE DE CONEXIONES POR DISPOSITIVO</h5>
                        </div>
                        <hr>
                        <div>
