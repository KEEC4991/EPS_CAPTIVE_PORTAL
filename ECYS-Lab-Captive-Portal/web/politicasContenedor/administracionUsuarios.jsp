    ...
    <div class="easyui-panel" style="width: 100%; height: 100%;" title="Administracion de Usuarios" >
        <div class="container" style="height: 100%;">
            ...
            <div id="ft_ad1" style="padding:2px 5px;">
                <a href="#" class="easyui-linkbutton" iconCls="icon-reload" plain="true" onclick="administracionUsuarios_Cambiar_Estado()">Cambiar Estado</a>
                <a href="#" class="easyui-linkbutton" iconCls="icon-reload" plain="true" onclick="cambiarTipo_Usuario()">Cambiar Tipo Usuario</a>
            </div>
        </div>
    </div>
</div>
