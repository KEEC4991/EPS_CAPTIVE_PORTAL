                            ...
                            <div class="row">
                                <div class="col" style="padding: 10px;">
                                    ...
                                    <div class="easyui-panel" title='<b>Ingrese sus credenciales de usuario: </b>' align='center' style="padding: 20px; margin-top: -5px;">
                                        <input id='txt_login_usuario_id' class="easyui-numberbox" data-options="prompt:'ID de Usuario',iconCls:'icon-man',required:true,missingMessage:'Ingrese su ID númerico de usuario.'" style="text-align: center; width: 50%;" />
                                        <input id='txt_login_usuario_pw' class="easyui-passwordbox" data-options="prompt:'Contraseña',required:true,missingMessage:'Puede visualizar su contraseña mientras la escribe.'" style="text-align: center; width: 50%;" />
